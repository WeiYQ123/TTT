import os
import sys
sys.path.append('E:/PythonProject/ProjectALL/TransFuse.py')

sys.path.append('E:/anaconda3/envs/ProjectALL/')
import torch
from torch.autograd import Variable
import argparse
from datetime import datetime
from wuwuwu import TransFuse_S
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', type=int, default=1, help='epoch number')#25
    parser.add_argument('--lr', type=float, default=0.1, help='learning rate')#7e-5
    parser.add_argument('--batchsize', type=int, default=2, help='training batch size')#16
    parser.add_argument('--grad_norm', type=float, default=2.0, help='gradient clipping norm')
    parser.add_argument('--train_path', type=str,
                        default='E:/PythonProject/ProjectALL/data', help='path to train dataset')#default='data/', help='path to train dataset'
    parser.add_argument('--test_path', type=str,
                        default='E:/PythonProject/ProjectALL/data', help='path to test dataset')
