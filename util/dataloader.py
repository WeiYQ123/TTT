...
#     path = 'E:/PythonProject/ProjectALL/data/'
...
#
#         plt.imshow(img)
#         plt.savefig('E:/PythonProject/ProjectALL/data/vis/'+str(i)+".jpg")
#
#         plt.imshow(gt[0])
#         plt.savefig('E:/PythonProject/ProjectALL/data/vis/'+str(i)+'_gt.jpg')
